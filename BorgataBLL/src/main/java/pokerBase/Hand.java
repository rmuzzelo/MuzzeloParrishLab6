...
public class Hand extends HandDomainModel {
	...
	public static ArrayList<Hand> ListHands(Hand PlayerHand, Hand CommonHand, GamePlay gme) {
		...
		int iPlayerNumberOfCards = gme.getGameRuleDomainModel().getPLAYERNUMBEROFCARDS();
		int iPlayerCardsMin = gme.getGameRuleDomainModel().getPLAYERCARDSMIN();
		int iPlayerCardsMax = gme.getGameRuleDomainModel().getPLAYERCARDSMAX();
		int iCommonCardsMin = gme.getGameRuleDomainModel().getCOMMUNITYCARDSMIN();
		int iCommonCardsMax = gme.getGameRuleDomainModel().getCOMMUNITYCARDSMAX();
